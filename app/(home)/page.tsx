...
import Header from "@/app/(home)/_components/sections/Aside";
import Projects from "@/app/(home)/_components/sections/Projects";
import TechSkills from "./_components/sections/TechSkills";

export default function Home() {
  return (
    <div className="animate-in fade-in mx-auto flex max-w-5xl flex-col gap-x-28 px-12 duration-300 ease-in lg:flex-row">
      <Header />
