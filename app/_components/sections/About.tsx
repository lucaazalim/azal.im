...
export default function About() {
    return (
        <section id="about" className="scroll-mt-24 max-lg:space-y-10">
            ...
            <div className="space-y-4 text-foreground-muted lg:px-5">
                ...
                <p>In 2011, I discovered Minecraft, and by 2013, I had launched my first Minecraft server. By
                    2017, I owned and operated the <a className="link" href="https://redesky.com">largest Minecraft
                        network in
                        Brazil</a>,
                ...
                <p>In 2022, I transitioned away from Minecraft to fully focus on advancing my career as a
                    Software Engineer. I am now pursuing a degree in Software Engineering at PUC Minas, channeling my
                    skills
