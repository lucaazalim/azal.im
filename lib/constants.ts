...
/** File name of the downloadable resume PDF, generated by `npm run resume:pdf`. */
export const RESUME_PDF_FILENAME = "luca-azalim-resume.pdf";
...
export const ROUTES = {
  ...
  academics: "/academics",
  resume: "/resume",
  /** Static PDF served from `public/`, generated by `npm run resume:pdf`. */
  resumePdf: `/resume/${RESUME_PDF_FILENAME}`,
